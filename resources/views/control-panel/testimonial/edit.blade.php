                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text"  class="form-control" id="name" name="name_en" value="{{ old('name_en',$project->name_en) }}" required autofocus >
                                </div>
                            </div>
                            {{-- end service name --}}
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description_en" id="description" class="form-control" rows="4">{{ old('description_en',$project->description_en) }}</textarea>
