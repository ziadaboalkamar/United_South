    ...
    <div class="col-xl-12 col-xxl-12 col-sm-12">
        <div class="card">
            <div class="card-header">
                ...
                <h5 class="card-title">{{ __('Edit Photo Album') }}</h5>
            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('photo-album.update',$album->id) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        {{-- project title --}}
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            @if($album->image)
                                <img src="{{ asset('storage/'.$album->image) }}" width="100" alt="{{ $album->name }}">
                            @endif
