                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text"  class="form-control" id="name_en" name="name_en" value="{{ old('name_en',$service->name_en) }}" required autofocus >
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="form-group fallback w-100">
                                ...
                                <textarea name="description_en" id="description" class="form-control" rows="4">{{ old('description',$service->description_en) }}</textarea>
                            </div>
                        </div>
                        {{-- end service description --}}
