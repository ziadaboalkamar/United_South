        ...
        <div class="col-xl-12 col-xxl-12 col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <h5 class="card-title">{{ __('Edit Project Station') }}</h5>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('update-project_station',$project->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="research" id="description" class="form-control" rows="4">{{ old('description',$project->research) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- service name --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="research_en" id="description" class="form-control" rows="4">{{ old('description',$project->research_en) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- website favicon --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @if($project->research_img)
                                    <img src="{{ asset('storage/'.$project->research_img) }}" width="100">
                                @endif
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="wireframe" id="description" class="form-control" rows="4">{{ old('description',$project->wireframe) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- service name --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="wireframe_en" id="description" class="form-control" rows="4">{{ old('description',$project->wireframe_en) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- website favicon --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @if($project->wireframe_img)
                                    <img src="{{ asset('storage/'.$project->wireframe_img) }}" width="100" >
                                @endif
                                <div class="form-group fallback w-100">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="design" id="description" class="form-control" rows="4">{{ old('description',$project->design) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="design_en" id="description" class="form-control" rows="4">{{ old('description',$project->design_en) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- website favicon --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @if($project->design_img)
                                    <img src="{{ asset('storage/'.$project->design_img) }}" width="100" >
                                @endif
                                <div class="form-group fallback w-100">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="development" id="description" class="form-control" rows="4">{{ old('description',$project->development) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- service name --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="development_en" id="description" class="form-control" rows="4">{{ old('description',$project->development_en) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- website favicon --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @if($project->development_img)
                                    <img src="{{ asset('storage/'.$project->development_img) }}" width="100" >
                                @endif
                                <div class="form-group fallback w-100">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="testing" id="description" class="form-control" rows="4">{{ old('description',$project->testing) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- service name --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="testing_en" id="description" class="form-control" rows="4">{{ old('description',$project->testing_en) }}</textarea>
                                </div>
                            </div>
                            {{-- end service name --}}
                            {{-- website favicon --}}
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                @if($project->testing_img)
                                    <img src="{{ asset('storage/'.$project->testing_img) }}" width="100" >
                                @endif
                                <div class="form-group fallback w-100">
