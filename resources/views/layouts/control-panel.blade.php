...
{{--                    </li>--}}
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-steam-square"></i>
                            <span class="nav-text">{{ __('Testimonial') }}</span>
                        </a>
                        <ul aria-expanded="false">
                            {{-- this element to view all services page --}}
                            <li><a href="{{ route('all-testimonial') }}">{{ __('All Testimonial') }}</a></li>

                            {{-- this element to view create services page --}}
                            <li><a href="{{ route('create-testimonial') }}">{{ __('Create Testimonial') }}</a></li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            {{-- this element to view all services page --}}
                            <li><a href="{{ route('all-about_us') }}">{{ __('All About Us') }}</a></li>

                            {{-- this element to view create services page --}}
                            <li><a href="{{ route('create-about_us') }}">{{ __('Create About Us') }}</a></li>

                        </ul>
                    </li>
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-steam-square"></i>
                            <span class="nav-text">{{ __('Project Station') }}</span>
                        </a>
                        <ul aria-expanded="false">
                            {{-- this element to view all services page --}}
                            <li><a href="{{ route('all-project_station') }}">{{ __('Project Station') }}</a></li>

                            {{-- this element to view create services page --}}
                            <li><a href="{{ route('create-project_station') }}">{{ __('Create Project Station') }}</a></li>
